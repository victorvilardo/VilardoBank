...
INSERT INTO TB_CLIENTE (nome, usuario, cpf, saldo, agencia, conta) VALUES
  ('Guilherme Abreu', 'gui', '60696996022', 1000000.00, 1, 123456),
  ('Thais Emanuel', 'thais', '60024193062', 1500000.00, 1, 987654),
  ('Jose da Silva', 'josesilva', '23164303092', 2000000.00, 1, 951753);
